...
static void print_index(Article a, FILE* f){
...
static void print_article(Article  a){
    ...
    fprintf(f,"<p><small><a href=\"%s/",a->url);
    char br[] = " ";
    ...
    fprintf(f,"\">Artigo Original</a></small></p>\n</div>\n");
